    ...
    return (
        <Form {...form}>
            ...
            <form
                ...
                className={cn(
                    "relative border p-3 sm:p-4 pt-1 rounded-xl bg-sidebar dark:bg-sidebar transition-all",
                    isFocused && "shadow-xs",
                ...
                <FormField 
                    ...
                    render={({ field }) => (
                        <TextareaAutosize
                            ...
                            minRows={2}
                            maxRows={8}
                            className="pt-4 resize-none border-none w-full outline-none bg-transparent text-sm sm:text-base"
